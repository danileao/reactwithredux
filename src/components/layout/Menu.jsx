...
import {
  Navbar, NavItem, SideNav, SideNavItem, Button, Icon, Row, Col,
    ...
    return (
      <Fragment>
        <Navbar style={{ background: '#41715f' }}>
          <NavItem>
            <Button id="icon_menu" onClick={this.handleSidebar} floating waves="yellow">
              <Icon>menu</Icon>
            </Button>
          </NavItem>
          <NavItem onClick={() => console.log('test click')}>PS - Front</NavItem>
